...
# model 
model = SimpleTransformer(dataset.get_vocab_size(), 
                          embedding_dim,
                          num_blocks,
                          num_heads,
                          output_size=3, 
...
print(f"{'Num blocks'.ljust(max_length)}: {num_blocks};")
print(f"{'Num heads'.ljust(max_length)}: {num_heads};")

# ================== save model ==================
# Specify the file path where you want to save the model
model_path = 'trained_models/simple_transformer.pth'
